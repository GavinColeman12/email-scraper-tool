...
def pick_email_with_llm(
    ...
    system_prompt = (
        ...
        "  - Generic/shared inboxes: info@, contact@, sales@, hello@, "
        "catering@, management@, reservations@, accessibility@, weare@, "
        "complimentarycasereview@, 233thompson@ (venue alias), "
        "barfelice@ (venue alias), etc. These are routed through an "
        "admin/receptionist and rarely reach the DM. New industries will "
        "invent new ones — use judgment.\n"
