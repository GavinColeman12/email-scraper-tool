...
QUERY_SYNONYMS = {
    ...
    # "law" on its own is how most operators actually type the query —
    # Google Maps treats it literally and returns very few results,
    # so we aggressively expand it. The more-specific "law firm" key
    # is defined further down in the legal section.
